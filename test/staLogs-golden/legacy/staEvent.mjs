//【golden 真理來源 — 改造前 (ADR-028 之前, git 38cd93e) 之 server/staLogs/staEvent.mjs 原樣留存, 只改 filterVpfsByWindow 之 import 路徑】
//用途: 由 gen-expected.mjs 於假時鐘下產出 expected.json; 不供 production 使用, 不要「修正」其語意 (含 ot(undefined) 視為 now 之舊行為)。
